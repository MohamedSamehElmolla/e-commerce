...
Route::put('/cart/decrease-qunatity/{rowId}',[CartController::class,'reduce_cart_quantity'])->name('cart.qty.decrease');
...
Route::post('/place-an-order',[CartController::class,'place_order'])->name('cart.place.an.order');
