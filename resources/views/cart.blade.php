...
@section('content')
<style>
    .cart-table-footer .position-relative {
    position: relative;
}

.cart-table-footer .form-control {
    padding-right: 100px; /* نترك مساحة كافية للزر داخل حقل الإدخال */
}

.cart-table-footer button.btn-danger {
    top: 0;
    right: 0;
    height: 100%;
    padding: 0 15px;
                            ...
                            @if (!Session::has('coupon'))
                                <form action="{{ route('cart.coupon.apply') }}" method="post">
                                    ...
                                    <div class="position-relative">
                                        <input class="form-control" type="text" name="coupon_code" placeholder="Coupon Code" value="Apply Coupon">
                                        <input class="btn-link fw-medium position-absolute top-0 end-0 h-100 px-4" type="submit" value="Apply">
                                    </div>
                                </form>
                            @else
                                <form action="{{ route('cart.coupon.remove') }}" method="post">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <button class="btn btn-danger position-absolute top-0 end-0 h-100 px-4" type="submit">Remove</button>
                                    </div>
                                </form>
                            @endif
