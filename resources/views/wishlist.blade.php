                    ...
                    <div class="cart-table__wrapper">
                      ...
                      <li>Size: L</li>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <form method="POST"
                                                        ...
                                                        @csrf
                                                        <button type="submit"
                                                            class="remove-cart btn btn-sm btn-warning">Move to Cart</button>
                                                    </form>
                                                </div>

                                                <div class="col-6">
                                                    <form method="POST" id="remove-item-{{ $item->rowId }}"
                        ...
                        <div class="cart-table-footer">
                            <form action="{{ route('wishlist.items.empty') }}" method="POST">
                                @csrf
                                @method('DELETE')
